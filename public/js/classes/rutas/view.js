...
let urls = new Urls();
let ui = new UI();
let urlsRutas = urls.rutas;
let rutas = new Rutas(urlsRutas);

//========================= Html
let tableHTML = urls.rutas.table;
let formHtml = urls.rutas.form;

export function loadRutas() {
    let html = "";

    //========================= Cargamos la tabla y los datos de la tabla
    Promise.all([ui.loadTable(tableHTML), rutas.getData()])
        .then((response) => {
...
function edit(id) {
    ...
    //========================= Form
    let form = document.querySelector("#form-rutas");
